<template>
  <div>
     ...
     <div id="opis" class="multiline">
      ...
      Sometimes mistaken for other bettas, the fan tail has a single tail that’s round and full.</p>
     </div>
     <br/>
     <h4 id="naslov1"><i><b>Tankmates</b></i></h4>
     <div id="opis" class="multiline">
     <p>Fantail Bettas, like any other bettas, are known for their aggression towards other male Bettas and should not be kept in the same aquarium unless it's a very very large tank with plenty of hiding places.<br/>
  ...
  <br/>
     ...
     <div id="opis" class="multiline">
      <p>Faintail bettas require a medium to large size tank (10+ gallons), highly planted with live plants.<br/>

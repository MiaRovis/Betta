<template>
  <div>
     ...
     <div id="opis" class="multiline">
      ...
      One of the most popular betta fish breeds, veiltail bettas are known for their long, spectacular fins and bright colors.</p>
     </div>
     <br/>
     <h4 id="naslov1"><i><b>Tankmates</b></i></h4>
     <div id="opis" class="multiline">
     <p>Veiltail Bettas, like any other bettas, are known for their aggression towards other male Bettas and should not be kept in the same aquarium unless it's a very very large tank with plenty of hiding places.<br/>
  ...
  <br/>
     ...
     <div id="opis" class="multiline">
      <p>Veiltail bettas require a medium to large size tank (10+ gallons), highly planted with live plants.<br/>

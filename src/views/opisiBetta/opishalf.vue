<template>
  <div>
     ...
     <div id="opis" class="multiline">
      ...
      One of the prettiest betta breeds, the halfmoon Betta has a 180-degree, fan-like tail that resembles a “D” when fully flared. This long-finned Betta also has unusual coloring.</p>
     </div>
     <br/>
     <h4 id="naslov1"><i><b>Tankmates</b></i></h4>
     <div id="opis" class="multiline">
     <p>Halfmoon Bettas, like any other bettas, are known for their aggression towards other male Bettas and should not be kept in the same aquarium unless it's a very very large tank with plenty of hiding places.<br/>
  ...
  <br/>
     ...
     <div id="opis" class="multiline">
      <p>Halfmoon bettas require a medium to large size tank (10+ gallons), highly planted with live plants.<br/>

<template>
  <div>
     ...
     Super delta bettas have tails with straight caudal edges—only theirs don’t reach 180 degrees like halfmoon bettas.</p>
     </div>
     <br/>
     <h4 id="naslov1"><i><b>Tankmates</b></i></h4>
     <div id="opis" class="multiline">
     <p>Super delta Bettas, like any other bettas, are known for their aggression towards other male Bettas and should not be kept in the same aquarium unless it's a very very large tank with plenty of hiding places.<br/>
  ...
  <br/>
     ...
     <div id="opis" class="multiline">
      <p>Super delta bettas require a medium to large size tank (10+ gallons), highly planted with live plants.<br/>
      hey enjoy warm, slow-moving waters with planty of hiding places, so driftwood can be a great addition to the tank.<br/>

<template>
  <div>
     ...
     <div id="opis" class="multiline">
      <p>The ancestors of all betta fish, plakat bettas have shorter tails with round or spade shapes. These strong, aggressive betta fish are less prone to injury and disease.<br/>
      The Betta fish has the scientific name Betta splendens, and it is native to freshwater settings in Southeast Asia.<br/>
      They can grow up to 3 inches in length, and only live 3 to 4 years in excellent conditions.</p>
  ...
  <br/>
     ...
     <div id="opis" class="multiline">
      <p>Plakat bettas require a medium to large size tank (10+ gallons), highly planted with live plants.<br/>

<template>
  <div>
     ...
     <div id="opis" class="multiline">
      ...
      They are native to Southeast Asia and can grow up to 3 inches in length.<br/>
      A kind of halfmoon Betta, the fantail (or rosetail Betta) has a fan-like tail, but has excessive branching and overlapping in its fin rays that resembles the ruffled appearance of a rose.</p>
     </div>
     <br/>
     <h4 id="naslov1"><i><b>Tankmates</b></i></h4>
     <div id="opis" class="multiline">
     <p>Feathertail Bettas, like any other bettas, are known for their aggression towards other male Bettas and should not be kept in the same aquarium unless it's a very very large tank with plenty of hiding places.<br/>
     However, female bettas can be kept togehter, as they are unlikely to fight, but they also require a pretty large tank.</p>
    </div>
     <br/>
 ...
 Peaceful species, especially those with smaller fins, like tetras, can make potential tankmates - they add pretty color to the tank but will not act agressively towards bettas.</p>
  ...
  <br/>
     ...
     <div id="opis" class="multiline">
      <p>Feathertail bettas require a medium to large size tank (10+ gallons), highly planted with live plants.<br/>
      They enjoy warm, slow-moving waters with planty of hiding places, so driftwood can be a great addition to the tank.<br/>
     The light should be light to moderate.</p>
     <p></p>
    </div>
    <br/>
